...
*__proto__* - is property of every variable that point to parent object that it is inheriting from. Whereas *prototype* is a property on constructor function that contains all the stuff that will be inherited by its instance.
